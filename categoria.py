...
app = Flask(__name__)
app.config["MONGO_URI"] = "mongodb://localhost:27017/categorias"
mongo = PyMongo(app)
db = mongo.db


@app.route('/api/categoria/<categoria_id>', methods=['GET'])
def getTodo(todo_id):
...
@app.route('/api/categoria/<categoria_id>', methods=['PATCH'])
...
@app.route('/api/categoria/<categoria_id>', methods=['DELETE'])
